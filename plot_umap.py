...
# Same color logic as the original UMAP figure.
        ...
        for path in paths:
            ...
            for batch in loader:
                ...
                for cid in class_ids[:n]:
                    # This follows the original test script label construction:
...
def plot_one_panel(ax, coords, labels, legend_labels, title=None, show_legend=True, point_size=4.0, alpha=0.45):
...
def main():
    parser = argparse.ArgumentParser(
        description="Create a publication-style 2x3 UMAP figure for Liver, NPC, and T Cell."
    )
    ...
    parser.add_argument("--ckpt", action="append", required=True,
                        help="Checkpoint mapping, e.g. --ckpt liver=outputs/liver/best.ckpt. Repeat for NPC and TCell.")
    parser.add_argument("--out", default="combined_umap_paper.pdf")
    parser.add_argument("--embedding_dim", type=int, default=128)
    parser.add_argument("--mask", action="store_true")
    parser.add_argument("--total_samples", type=int, default=5000,
                        help="Approximate total sampled points per panel.")
    ...
    parser.add_argument("--save_npz", action="store_true",
                        help="Also save UMAP coordinates and labels next to the output figure.")
    ...
    fig, axes = plt.subplots(2, 3, figsize=(9.2, 5.25))
    ...
    fig.supxlabel("UMAP Dimension 1", fontsize=10.5, y=0.055)
    fig.supylabel("UMAP Dimension 2", fontsize=10.5, x=0.030)
