...
plt.savefig(args.model_infile.split(".ckpt")[0] + f"_{args.margin:.1f}_train_distribution.pdf")
plt.close()
...
plt.ylabel("Density")
plt.xlabel("Euclidean Distance of Representation")
plt.savefig(args.model_infile.split(".ckpt")[0] + f"_{args.margin:.1f}_test_distribution.pdf")
plt.close()
