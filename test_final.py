...
out_csv = os.path.join(
    m_dir,
    f"{m_base}_performance_summary_threshold_{args.threshold_data}_{args.threshold_method}.csv"
)
...
timing_csv = os.path.join(
    m_dir,
    f"{m_base}_timing_summary_threshold_{args.threshold_data}_{args.threshold_method}.csv"
)
